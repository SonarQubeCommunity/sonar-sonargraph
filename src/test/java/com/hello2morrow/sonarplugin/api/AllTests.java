...
@RunWith(Suite.class)
@SuiteClasses({ReadTest.class, SonargraphPluginTest.class, SonargraphRulesRepositoryTest.class, SonargraphInternalMetricsTest.class, SonargraphSensorTest.class,
  ReportFileReaderTest.class, UtilitiesTest.class, SonargraphBuildUnitMetricsTest.class, SonargraphSystemMetricsTest.class})
