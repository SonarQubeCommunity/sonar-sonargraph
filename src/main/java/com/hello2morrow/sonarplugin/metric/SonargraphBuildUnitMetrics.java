...
public final class SonargraphBuildUnitMetrics implements Metrics {
  ...
  public static final Metric CYCLICITY = new Metric.Builder("sonargraph_cyclicity", "Cyclicity", Metric.ValueType.INT)
      ...
      .setQualitative(true).setDomain(SonargraphSystemMetrics.DOMAIN_SONARGRAPH).create();
  ...
  public static final Metric INSTRUCTIONS = new Metric.Builder("sonargraph_instructions", "Byte Code Instructions",
      ...
      .setQualitative(false).setDomain(SonargraphSystemMetrics.DOMAIN_SONARGRAPH).create();
  ...
  public static final Metric CYCLE_GROUP_SIZE = new Metric.Builder("sonargraph_cycle_group_size", "Cycle Group Size",
      ...
      .setDirection(Metric.DIRECTION_WORST).setQualitative(true).setDomain(SonargraphSystemMetrics.DOMAIN_SONARGRAPH)
      .create();
  ...
  public static final Metric TYPE_DEPENDENCIES = new Metric.Builder("sonargraph_type_dependencies",
      ...
      .setDirection(Metric.DIRECTION_NONE).setQualitative(false).setDomain(SonargraphSystemMetrics.DOMAIN_SONARGRAPH)
      .create();
  ...
  public static final Metric TASKS = new Metric.Builder("sonargraph_tasks", "Open Tasks", Metric.ValueType.INT)
      ...
      .setDomain(SonargraphSystemMetrics.DOMAIN_SONARGRAPH).create();
  ...
  public List<Metric> getMetrics() {
    return Arrays.asList(CYCLICITY, CYCLIC_PACKAGES, INTERNAL_PACKAGES, INSTRUCTIONS, CYCLE_GROUP_SIZE,
        UNASSIGNED_TYPES, VIOLATING_TYPES, VIOLATING_DEPENDENCIES, TYPE_DEPENDENCIES, JAVA_FILES, TASKS, EROSION_INDEX,
        THRESHOLD_WARNINGS, DUPLICATE_WARNINGS, IGNORED_WARNINGS, IGNORED_VIOLATONS, EROSION_REFS, EROSION_TYPES,
        EROSION_COST, INTERNAL_TYPES, TASK_REFS, MODULE_NOT_PART_OF_SONARGRAPH_WORKSPACE);
  }
}
